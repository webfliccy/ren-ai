...
test("renders title as a link", () => {
  ...
  expect(screen.getByRole("heading", { level: 2 }).textContent).toBe("An Essay on Machines");
  expect(screen.getByRole("link")).toHaveProperty("pathname", "/an-essay-on-machines");
});
